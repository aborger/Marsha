...
num_episodes = 500           # Number of training sessions
...
copy_rate = 20            # The number of frames before target rnn is copied to main rnn
...
max_frames = 150             # Number of frames that will deem an episode unsuccessfull if the goal_reward is not reached
