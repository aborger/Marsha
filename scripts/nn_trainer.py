...
class NN_Trainer(object):
    def __init__(self):
        rospy.init_node('Trainer', log_level=rospy.DEBUG)
        ...
        # This is really efficient and unnecessary! The algo can handle many motors at once by sending them as batches
        # There is no need to have a trainer for a bunch of nns
