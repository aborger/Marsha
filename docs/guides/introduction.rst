...
This artificial intelligence algorithm will take a 3D-point cloud generated by the `Intel RealSense D435`_ as the input.
...
.. _`Transformer Model`: https://en.wikipedia.org/wiki/Transformer_(machine_learning_model)
