...
(cl:defmethod cl:initialize-instance :after ((m <Floats>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Floats)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name marsha-msg:<Floats> is deprecated: use marsha-msg:Floats instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <Floats>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader marsha-msg:data-val is deprecated.  Use marsha-msg:data instead.")
  (data m))
