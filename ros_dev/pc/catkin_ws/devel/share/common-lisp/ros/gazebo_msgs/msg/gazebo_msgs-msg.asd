...
(defsystem "gazebo_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "PerformanceMetrics" :depends-on ("_package_PerformanceMetrics"))
    (:file "_package_PerformanceMetrics" :depends-on ("_package"))
    (:file "SensorPerformanceMetric" :depends-on ("_package_SensorPerformanceMetric"))
    (:file "_package_SensorPerformanceMetric" :depends-on ("_package"))
