...
get_filename_component(_filename "C:/Users/borge/MARSHA/ros_dev/pc/catkin_ws/src/ros_tutorials/roscpp_tutorials/srv/TwoInts.srv" NAME_WE)
add_custom_target(_roscpp_tutorials_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "roscpp_tutorials" "C:/Users/borge/MARSHA/ros_dev/pc/catkin_ws/src/ros_tutorials/roscpp_tutorials/srv/TwoInts.srv" ""
)
...
_generate_srv_cpp(roscpp_tutorials
  "C:/Users/borge/MARSHA/ros_dev/pc/catkin_ws/src/ros_tutorials/roscpp_tutorials/srv/TwoInts.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/roscpp_tutorials)
  install(CODE "execute_process(COMMAND \"C:/opt/ros/melodic/x64/python.exe\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/roscpp_tutorials\")")
  # install generated code
  install(
